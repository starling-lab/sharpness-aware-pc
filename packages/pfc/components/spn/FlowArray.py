...
import numpy as np  
import itertools
from packages.pfc.components.flows.Splines import *
from packages.pfc.components.flows.Householder import *
from packages.pfc.components.flows.Affine import *
from packages.pfc.components.spn.ExponentialFamilyArray import NormalArray, shift_last_axis_to
